...
// setBatteryLevelMonitoring()
// setVolumeControl()
// setPlayPauseStatus()
// manageConnectedDevices()
// setMultipointConnection()
// captureVoiceDuringCalls()
// getPlaybackMetadata()
// setSpeakToChatSettings()
// configureEqualizer()
// mapTouchSensorFunction()
...
Headphones::Headphones(BluetoothWrapper& conn) : _conn(conn)
{
    ...
    setBatteryLevelMonitoring(true);
    setVolumeControl(50);
    setPlayPauseStatus(false);
    manageConnectedDevices();
    setMultipointConnection(true);
    captureVoiceDuringCalls();
    getPlaybackMetadata();
    setSpeakToChatSettings(true);
    configureEqualizer(0, 0);
    mapTouchSensorFunction(0);
}
{
}
